...
<html lang="en">
<head>
    <title>Code coverage report for HttpLink.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> HttpLink.ts
    </h1>
    <div class='clearfix'>
...
99
100
101</td><td class="line-coverage quiet"><span class="cline-any cline-yes">3x</span>
...
&nbsp;
          const obs = httpClient.post&lt;Object&gt;(endpointURI || <span class="branch-1 cbranch-no" title="branch not covered" >defaultURI,</span> body, {
            observe: 'response',
            responseType: 'json',
...
&nbsp;
          const sub = obs.subscribe({
            ...
            error: <span class="fstat-no" title="function not covered" >(</span>err: Error) =&gt; {
...
&nbsp;
          return () =&gt; {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (!sub.closed) {
              sub.unsubscribe();
            }
          };
        }),
...
export class HttpLink {
  constructor(private httpClient: HttpClient<span class="branch-1 cbranch-no" title="branch not covered" >) {}</span>
&nbsp;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Thu Oct 19 2017 12:29:07 GMT+0200 (CEST)
</div>
</div>
